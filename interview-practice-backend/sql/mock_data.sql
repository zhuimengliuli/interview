...
VALUES (1, 'user1', 'b0dd3697a192885d7c055db46155b26a', 'user1',
       ...
       (5, 'xcx2021', 'b0dd3697a192885d7c055db46155b26a', 'xcx2021', 'https://www.code-nav.cn/logo.png',
        '系统管理员', 'admin');

-- 题库表初始数据
INSERT INTO bank (title, description, picture, userId)
...
-- 题库题目关联初始数据
INSERT INTO question_bank (bankId, questionId, userId)
VALUES (1, 1, 1),
       (1, 2, 1),
       (1, 3, 1),
       (1, 4, 1),
