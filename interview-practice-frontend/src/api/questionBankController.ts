...
/** batchAddQuestionsToBank POST /api/questionBank/batch/add */
export async function batchAddQuestionsToBankUsingPost(
  body: API.QuestionBankBatchAddRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>("/api/questionBank/batch/add", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
/** batchRemoveQuestionsFromBank POST /api/questionBank/batch/delete */
export async function batchRemoveQuestionsFromBankUsingPost(
  body: API.QuestionBankBatchRemoveRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>("/api/questionBank/batch/delete", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
/** removeQuestionBank POST /api/questionBank/remove */
export async function removeQuestionBankUsingPost(
  body: API.QuestionBankRemoveRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>("/api/questionBank/remove", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
